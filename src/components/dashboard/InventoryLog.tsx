...
const InventoryLog = ({ entries }: InventoryLogProps) => {
  return (
    <motion.div
      ...
      className="bg-card rounded-2xl p-6 shadow-soft border border-border overflow-hidden"
    >
      <h3 className="font-display text-xl font-semibold mb-4">Inventory Log</h3>
