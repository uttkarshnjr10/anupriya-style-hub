...
// import OnlineInventoryList from "@/components/dashboard/OnlineInventoryList";
...
//         >
//           <h1 className="font-display text-3xl font-bold text-foreground">Online Inventory Manager</h1>
//           <p className="text-muted-foreground mt-1">Control what customers see on the /shop page</p>
//         </motion.div>

//         {/* Grid Layout */}
//         <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
//           {/* Add to Online Catalog Form */}
//           <OnlineInventoryForm />
